...
import { ShieldAlert, ShieldCheck, Key, Lock, CheckCircle, Smartphone, ChevronRight } from "lucide-react";
                ...
                <div className="lg:col-span-6 bg-white border border-slate-200/60 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col justify-between text-left space-y-6">
                    <div className="space-y-4">
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-4">
                            <div>
                                <label className="block text-[10px] font-black uppercase text-slate-500 tracking-wider mb-2">Mot de passe actuel</label>
                                <input
                            ...
                            <div>
                                <label className="block text-[10px] font-black uppercase text-slate-500 tracking-wider mb-2">Nouveau mot de passe</label>
                                <input
                            ...
                            >
                                {loading ? <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> : "Mettre à jour"}
                            </button>
                        </form>
                    </div>
                </div>
