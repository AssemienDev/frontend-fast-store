    ...
    return (
        <div className="p-6 md:p-8 space-y-8 max-w-6xl w-full mx-auto relative">
            ...
            <div className="text-center max-w-2xl mx-auto mb-12">
                ...
                <Link href="/billing/history" className="w-1/2 py-3 mt-10 rounded-xl bg-primary text-white font-extrabold text-xs flex items-center justify-center cursor-pointer">
                    Mon Historique
                </Link>
